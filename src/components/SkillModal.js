...
const SkillModal = ({ skill, onClose }) => {
	...
	return createPortal(
		<div className='fixed inset-0 bg-dark bg-opacity-50 flex items-center justify-center z-50 fade-in'>
			<div className='bg-light border-2 border-solid border-dark p-2 rounded-lg w-1/3 h-1/6 text-center items-center relative grid grid-cols-2 grid-rows-3 slide-in'>
